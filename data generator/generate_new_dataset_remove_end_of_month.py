...
BASE_PATTERN.plot(plot_till=24,filename='./dataset_remove_end_of_month/no change/img/base_pattern_24')
BASE_PATTERN.plot(plot_till=24*7,filename='./dataset_remove_end_of_month/no change/img/base_pattern_24_7')
BASE_PATTERN.plot(plot_till=24*28,filename='./dataset_remove_end_of_month/no change/img/base_pattern_24_28')
...
hd_pattern_list = get_pulse_list(num=n, length_mean=hd_len_mean, length_std=hd_len_std, amplitude=hd_amp, verbose=True, plot_the_smoother_line=True, fileName_start_with = "dataset_remove_end_of_month/no change/img/hours_in_day_Pattern")
...
for i in range(n):
    ...
    dw_pattern_list[i].plot(filename="dataset_remove_end_of_month/no change/img/days_in_week_Pattern_"+str(i+1))
...
#     dm_pattern_list[i].plot(filename="dataset_remove_end_of_month/no change/img/days_in_month_Pattern_"+str(i+1))
#
# dm_position_list = []
...
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start =0, plot_till=24*30, filename='./dataset_remove_end_of_month/no change/img/mixed_pattern_24_30')
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_till=24*7, filename='./dataset_remove_end_of_month/no change/img/mixed_pattern_24_7')
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_till=24, filename='./dataset_remove_end_of_month/no change/img/mixed_pattern_24')
BASE_PATTERN.plot(plot_the_smoother_line = True, filename='./dataset_remove_end_of_month/no change/img/mixed_pattern_all')
smooth_ys = BASE_PATTERN.get_smooth_values()
np.save('dataset_remove_end_of_month/no change/Dataset_3_normal.npy', smooth_ys)
...
num_random_holidays = int(5 / 365 * num_days)
...
holidays_peak_magni_list = (np.random.uniform(low=2.0, high=3.0, size=len(holidays_peak))).tolist()
BASE_PATTERN.multiply(position_tuple_list=holidays_peak_position_list, magnitude_list=holidays_peak_magni_list, bump_the_smoother_line = True, ramp_it = False)

plot_spot = holidays_peak_position_list[np.random.randint(len(holidays_peak_position_list))][0]
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start = plot_spot - 24 * 10, plot_till = plot_spot + 24 * 20, filename='./dataset_remove_end_of_month/with change/img/anomaly_peak_24_30')
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start = plot_spot - 24 * 3,  plot_till = plot_spot + 24 * 4, filename='./dataset_remove_end_of_month/with change/img/anomaly_peak_24_7')
BASE_PATTERN.plot(plot_the_smoother_line = True, filename='./dataset_remove_end_of_month/with change/img/anomaly_peak_all')
...
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start = plot_spot - 24 * 10, plot_till = plot_spot + 24 * 20, filename='./dataset_remove_end_of_month/with change/img/anomaly_dent_24_30')
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start = plot_spot - 24 * 3,  plot_till = plot_spot + 24 * 4, filename='./dataset_remove_end_of_month/with change/img/anomaly_dent_24_7')
BASE_PATTERN.plot(plot_the_smoother_line = True, filename='./dataset_remove_end_of_month/with change/img/anomaly_all')

np.save("dataset_remove_end_of_month/with change/anomaly_peak_start_end_timesteps.npy", np.array(holidays_peak_position_list))
np.save("dataset_remove_end_of_month/with change/anomaly_dent_start_end_timesteps.npy", np.array(holidays_dent_position_list))

smooth_ys = BASE_PATTERN.get_smooth_values()
np.save('dataset_remove_end_of_month/with change/Dataset_3_anomaly.npy', smooth_ys)
...
short_threshold = 10 * 24
short_change_duration = 5 * 24
position_med_changes = []
med_threshold = 14 * 24
med_change_duration = 10 * 24
position_long_changes = []
long_threshold = 28 * 24
long_change_duration = 18 * 24
...
# BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start = plot_spot - 24 * 5, plot_till = plot_spot + 24 * 9, filename='./dataset_remove_end_of_month/with change/img/change_short_2weeks')

plot_spot = position_med_changes[np.random.randint(len(position_med_changes))][0]
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start = plot_spot - 24 * 10,  plot_till = plot_spot + 24 * 20, filename='./dataset_remove_end_of_month/with change/img/change_med_1month')

plot_spot = position_long_changes[np.random.randint(len(position_long_changes))][0]
BASE_PATTERN.plot(plot_the_smoother_line = True, plot_start = plot_spot - 24 * 20,  plot_till = plot_spot + 24 * 40, filename='./dataset_remove_end_of_month/with change/img/change_long_2months')


BASE_PATTERN.plot(plot_the_smoother_line = True, filename='./dataset_remove_end_of_month/with change/img/change_anomaly_all')

# position_short_changes = np.array(position_short_changes)
# np.save("dataset_remove_end_of_month/with change/change_short_start_end_timesteps.npy",position_short_changes)
position_med_changes = np.array(position_med_changes)
np.save("dataset_remove_end_of_month/with change/change_med_start_end_timesteps.npy",position_med_changes)
position_long_changes = np.array(position_long_changes)
np.save("dataset_remove_end_of_month/with change/change_long_start_end_timesteps.npy",position_long_changes)

smooth_ys = BASE_PATTERN.get_smooth_values()
np.save('dataset_remove_end_of_month/with change/Dataset_3_change_anomaly.npy', smooth_ys)

print("####\nNumber of anomalies: " + str(len(holidays_dent_position_list) + len(holidays_peak_position_list)) + "\n####")
print("####\nNumber of changes: " + str(len(position_med_changes) + len(position_long_changes)) + "\n####")
