...
def prepare():
	...
	data = read_data('../data/fake_data/dataset_4/Dataset_3_change_anomaly.npy') #(2400001)
	...
	np.save("../data/fake_data/dataset_4/elect_pre_train_data", shift_train_data)
	np.save("../data/fake_data/dataset_4/elect_train_onehot", shift_train_onehot)
	np.save("../data/fake_data/dataset_4/elect_train_v", v)
	np.save("../data/fake_data/dataset_4/elect_train_label", shift_train_label)
	np.save("../data/fake_data/dataset_4/elect_train_param", param)
	np.save("../data/fake_data/dataset_4/elect_train_index", indexs_list)
	np.save("../data/fake_data/dataset_4/elect_train_pred_index", indexs_pred_list)
	#np.save("./data/fake_data/dataset_4/elect_train_p_value", shift_train_pvalue)
	return
