...
def read(data_file_list):
	#read covariates
	hour_of_the_day = read_covar("./data/hour.csv")
	day_of_the_week = read_covar("./data/day.csv")
...
np.save("./data/shift_train_data.npy",shift_train_data)
np.save("./data/shift_train_onehot.npy",shift_train_onehot)
np.save("./data/v.npy",v)
np.save("./data/shift_train_label.npy",shift_train_label)
np.save("./data/param.npy", param)
np.save("./data/indexs_list.npy", indexs_list)
np.save("./data/indexs_pred_list.npy", indexs_pred_list)
